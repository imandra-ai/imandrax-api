...
val default_test_src_req : 
  ?session:Session.session option ->
  ?src:string ->
  ?seed:int64 ->
  unit ->
  test_src_req
(** [default_test_src_req ()] is the default value for type [test_src_req] *)

val default_qcheck_src_req : 
  ?session:Session.session option ->
  ?src:string ->
  ?seed:int64 ->
  unit ->
  qcheck_src_req
(** [default_qcheck_src_req ()] is the default value for type [qcheck_src_req] *)

val default_test_name_req : 
  ?session:Session.session option ->
  ?name:string ->
  ?seed:int64 ->
  unit ->
  test_name_req
(** [default_test_name_req ()] is the default value for type [test_name_req] *)

val default_qcheck_name_req : 
  ?session:Session.session option ->
  ?name:string ->
  ?seed:int64 ->
  unit ->
  qcheck_name_req
(** [default_qcheck_name_req ()] is the default value for type [qcheck_name_req] *)
...
(** [default_test_res_res ()] is the default value for type [test_res_res] *)

val default_test_res : 
  ?res:test_res_res ->
  ?errors:Error.error list ->
  ?task:Task.task option ->
  unit ->
  test_res
(** [default_test_res ()] is the default value for type [test_res] *)
...
val default_get_decls_req : 
  ?session:Session.session option ->
  ?name:string list ->
  ?str:bool ->
  unit ->
  get_decls_req
(** [default_get_decls_req ()] is the default value for type [get_decls_req] *)

val default_decl_with_name : 
  ?name:string ->
  ?artifact:Artmsg.art option ->
  ?str:string option ->
  unit ->
  decl_with_name
(** [default_decl_with_name ()] is the default value for type [decl_with_name] *)

val default_get_decls_res : 
  ?decls:decl_with_name list ->
  ?not_found:string list ->
  unit ->
  get_decls_res
(** [default_get_decls_res ()] is the default value for type [get_decls_res] *)
