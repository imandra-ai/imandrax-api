...
export interface DecomposeReq2_LocalVarLet {
...
export interface DecomposeReq2_Decomp {
  ...
  set?: DecomposeReq2_LocalVarLet | undefined;
}
...
function createBaseDecomposeReq2_LocalVarLet(): DecomposeReq2_LocalVarLet {
  return { bindings: [], andThen: undefined };
}

export const DecomposeReq2_LocalVarLet: MessageFns<DecomposeReq2_LocalVarLet> = {
  encode(message: DecomposeReq2_LocalVarLet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_LocalVarLet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_LocalVarLet();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DecomposeReq2_LocalVarLet {
    return {
  ...
  toJSON(message: DecomposeReq2_LocalVarLet): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<DecomposeReq2_LocalVarLet>, I>>(base?: I): DecomposeReq2_LocalVarLet {
    return DecomposeReq2_LocalVarLet.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_LocalVarLet>, I>>(object: I): DecomposeReq2_LocalVarLet {
    const message = createBaseDecomposeReq2_LocalVarLet();
...
export const DecomposeReq2_Decomp: MessageFns<DecomposeReq2_Decomp> = {
  encode(message: DecomposeReq2_Decomp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.set !== undefined) {
      DecomposeReq2_LocalVarLet.encode(message.set, writer.uint32(90).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          message.set = DecomposeReq2_LocalVarLet.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DecomposeReq2_Decomp {
    return {
      ...
      set: isSet(object.set) ? DecomposeReq2_LocalVarLet.fromJSON(object.set) : undefined,
    };
  },
  ...
  toJSON(message: DecomposeReq2_Decomp): unknown {
    ...
    if (message.set !== undefined) {
      obj.set = DecomposeReq2_LocalVarLet.toJSON(message.set);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_Decomp>, I>>(object: I): DecomposeReq2_Decomp {
    ...
    message.set = (object.set !== undefined && object.set !== null)
      ? DecomposeReq2_LocalVarLet.fromPartial(object.set)
      : undefined;
    return message;
  },
};
