...
export interface DecomposeReq2 {
  session: Session | undefined;
  decomp:
    | DecomposeReq2_Decomp
    | undefined;
  /** include result as string? */
  str?: boolean | undefined;
  timeout?: number | undefined;
...
export interface DecomposeReq2_ByName {
  /** name of function to decompose */
  name: string;
  /** name of side condition function */
  assuming?: string | undefined;
...
export interface DecomposeReq2_Prune {
  d: DecomposeReq2_Decomp | undefined;
}

export interface DecomposeReq2_Combine {
  d: DecomposeReq2_Decomp | undefined;
}

export interface DecomposeReq2_Merge {
  d1: DecomposeReq2_Decomp | undefined;
  d2: DecomposeReq2_Decomp | undefined;
}

export interface DecomposeReq2_CompoundMerge {
  d1: DecomposeReq2_Decomp | undefined;
  d2: DecomposeReq2_Decomp | undefined;
}

export interface DecomposeReq2_LocalVarBinding {
...
export interface DecomposeReq2_LocalVarParallelSet {
  /** list of bindings to do in parallel */
  bindings: DecomposeReq2_LocalVarBinding[];
  /** the decomposition to do after the bindings are evaluated */
  andThen: DecomposeReq2_Decomp | undefined;
}

export interface DecomposeReq2_LocalVarGet {
  /** Get the result stored in the variable with the given name */
  name: string;
}

/** The main description of what to decompose */
export interface DecomposeReq2_Decomp {
  fromArtifact?: Art | undefined;
  byName?: DecomposeReq2_ByName | undefined;
  merge?: DecomposeReq2_Merge | undefined;
  compoundMerge?: DecomposeReq2_CompoundMerge | undefined;
  prune?: DecomposeReq2_Prune | undefined;
  combine?: DecomposeReq2_Combine | undefined;
  get?: DecomposeReq2_LocalVarGet | undefined;
  set?: DecomposeReq2_LocalVarParallelSet | undefined;
}
...
function createBaseDecomposeReq2(): DecomposeReq2 {
  return { session: undefined, decomp: undefined, str: undefined, timeout: undefined };
}

export const DecomposeReq2: MessageFns<DecomposeReq2> = {
  encode(message: DecomposeReq2, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.session !== undefined) {
      Session.encode(message.session, writer.uint32(10).fork()).join();
    }
    if (message.decomp !== undefined) {
      DecomposeReq2_Decomp.encode(message.decomp, writer.uint32(18).fork()).join();
    }
    if (message.str !== undefined) {
      writer.uint32(72).bool(message.str);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2 {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.decomp = DecomposeReq2_Decomp.decode(reader, reader.uint32());
          continue;
        }
        case 9: {
          if (tag !== 72) {
  ...
  fromJSON(object: any): DecomposeReq2 {
    return {
      session: isSet(object.session) ? Session.fromJSON(object.session) : undefined,
      decomp: isSet(object.decomp) ? DecomposeReq2_Decomp.fromJSON(object.decomp) : undefined,
      str: isSet(object.str) ? globalThis.Boolean(object.str) : undefined,
      timeout: isSet(object.timeout) ? globalThis.Number(object.timeout) : undefined,
    };
  },

  toJSON(message: DecomposeReq2): unknown {
    const obj: any = {};
    if (message.session !== undefined) {
      obj.session = Session.toJSON(message.session);
    }
    if (message.decomp !== undefined) {
      obj.decomp = DecomposeReq2_Decomp.toJSON(message.decomp);
    }
    if (message.str !== undefined) {
      obj.str = message.str;
    }
  ...
  create<I extends Exact<DeepPartial<DecomposeReq2>, I>>(base?: I): DecomposeReq2 {
    return DecomposeReq2.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2>, I>>(object: I): DecomposeReq2 {
    const message = createBaseDecomposeReq2();
    message.session = (object.session !== undefined && object.session !== null)
      ? Session.fromPartial(object.session)
      : undefined;
    message.decomp = (object.decomp !== undefined && object.decomp !== null)
      ? DecomposeReq2_Decomp.fromPartial(object.decomp)
      : undefined;
    message.str = object.str ?? undefined;
    message.timeout = object.timeout ?? undefined;
    return message;
...
function createBaseDecomposeReq2_ByName(): DecomposeReq2_ByName {
  return {
    name: "",
    assuming: undefined,
    basis: [],
...
export const DecomposeReq2_ByName: MessageFns<DecomposeReq2_ByName> = {
  encode(message: DecomposeReq2_ByName, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(18).string(message.name);
    }
    if (message.assuming !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_ByName {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_ByName();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2: {
  ...
  fromJSON(object: any): DecomposeReq2_ByName {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      assuming: isSet(object.assuming) ? globalThis.String(object.assuming) : undefined,
      basis: globalThis.Array.isArray(object?.basis) ? object.basis.map((e: any) => globalThis.String(e)) : [],
  ...
  toJSON(message: DecomposeReq2_ByName): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<DecomposeReq2_ByName>, I>>(base?: I): DecomposeReq2_ByName {
    return DecomposeReq2_ByName.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_ByName>, I>>(object: I): DecomposeReq2_ByName {
    const message = createBaseDecomposeReq2_ByName();
    message.name = object.name ?? "";
    message.assuming = object.assuming ?? undefined;
    message.basis = object.basis?.map((e) => e) || [];
...
function createBaseDecomposeReq2_Prune(): DecomposeReq2_Prune {
  return { d: undefined };
}

export const DecomposeReq2_Prune: MessageFns<DecomposeReq2_Prune> = {
  encode(message: DecomposeReq2_Prune, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.d !== undefined) {
      DecomposeReq2_Decomp.encode(message.d, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_Prune {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_Prune();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.d = DecomposeReq2_Decomp.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DecomposeReq2_Prune {
    return { d: isSet(object.d) ? DecomposeReq2_Decomp.fromJSON(object.d) : undefined };
  },

  toJSON(message: DecomposeReq2_Prune): unknown {
    const obj: any = {};
    if (message.d !== undefined) {
      obj.d = DecomposeReq2_Decomp.toJSON(message.d);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<DecomposeReq2_Prune>, I>>(base?: I): DecomposeReq2_Prune {
    return DecomposeReq2_Prune.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_Prune>, I>>(object: I): DecomposeReq2_Prune {
    const message = createBaseDecomposeReq2_Prune();
    message.d = (object.d !== undefined && object.d !== null) ? DecomposeReq2_Decomp.fromPartial(object.d) : undefined;
    return message;
  },
};

function createBaseDecomposeReq2_Combine(): DecomposeReq2_Combine {
  return { d: undefined };
}

export const DecomposeReq2_Combine: MessageFns<DecomposeReq2_Combine> = {
  encode(message: DecomposeReq2_Combine, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.d !== undefined) {
      DecomposeReq2_Decomp.encode(message.d, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_Combine {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_Combine();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DecomposeReq2_Combine {
    return { d: isSet(object.d) ? DecomposeReq2_Decomp.fromJSON(object.d) : undefined };
  },

  toJSON(message: DecomposeReq2_Combine): unknown {
    const obj: any = {};
    if (message.d !== undefined) {
      obj.d = DecomposeReq2_Decomp.toJSON(message.d);
    }
  ...
  create<I extends Exact<DeepPartial<DecomposeReq2_Combine>, I>>(base?: I): DecomposeReq2_Combine {
    return DecomposeReq2_Combine.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_Combine>, I>>(object: I): DecomposeReq2_Combine {
    const message = createBaseDecomposeReq2_Combine();
    message.d = (object.d !== undefined && object.d !== null) ? DecomposeReq2_Decomp.fromPartial(object.d) : undefined;
    return message;
  },
...
function createBaseDecomposeReq2_Merge(): DecomposeReq2_Merge {
  return { d1: undefined, d2: undefined };
}

export const DecomposeReq2_Merge: MessageFns<DecomposeReq2_Merge> = {
  encode(message: DecomposeReq2_Merge, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.d1 !== undefined) {
      DecomposeReq2_Decomp.encode(message.d1, writer.uint32(10).fork()).join();
    }
    if (message.d2 !== undefined) {
      DecomposeReq2_Decomp.encode(message.d2, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_Merge {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_Merge();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.d1 = DecomposeReq2_Decomp.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.d2 = DecomposeReq2_Decomp.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DecomposeReq2_Merge {
    return {
      d1: isSet(object.d1) ? DecomposeReq2_Decomp.fromJSON(object.d1) : undefined,
      d2: isSet(object.d2) ? DecomposeReq2_Decomp.fromJSON(object.d2) : undefined,
    };
  },

  toJSON(message: DecomposeReq2_Merge): unknown {
    const obj: any = {};
    if (message.d1 !== undefined) {
      obj.d1 = DecomposeReq2_Decomp.toJSON(message.d1);
    }
    if (message.d2 !== undefined) {
      obj.d2 = DecomposeReq2_Decomp.toJSON(message.d2);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<DecomposeReq2_Merge>, I>>(base?: I): DecomposeReq2_Merge {
    return DecomposeReq2_Merge.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_Merge>, I>>(object: I): DecomposeReq2_Merge {
    const message = createBaseDecomposeReq2_Merge();
    message.d1 = (object.d1 !== undefined && object.d1 !== null)
      ? DecomposeReq2_Decomp.fromPartial(object.d1)
      : undefined;
    message.d2 = (object.d2 !== undefined && object.d2 !== null)
      ? DecomposeReq2_Decomp.fromPartial(object.d2)
      : undefined;
    return message;
  },
};

function createBaseDecomposeReq2_CompoundMerge(): DecomposeReq2_CompoundMerge {
  return { d1: undefined, d2: undefined };
}

export const DecomposeReq2_CompoundMerge: MessageFns<DecomposeReq2_CompoundMerge> = {
  encode(message: DecomposeReq2_CompoundMerge, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.d1 !== undefined) {
      DecomposeReq2_Decomp.encode(message.d1, writer.uint32(10).fork()).join();
    }
    if (message.d2 !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_CompoundMerge {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_CompoundMerge();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DecomposeReq2_CompoundMerge {
    return {
      d1: isSet(object.d1) ? DecomposeReq2_Decomp.fromJSON(object.d1) : undefined,
      d2: isSet(object.d2) ? DecomposeReq2_Decomp.fromJSON(object.d2) : undefined,
    };
  ...
  toJSON(message: DecomposeReq2_CompoundMerge): unknown {
    const obj: any = {};
    if (message.d1 !== undefined) {
      obj.d1 = DecomposeReq2_Decomp.toJSON(message.d1);
    }
  ...
  create<I extends Exact<DeepPartial<DecomposeReq2_CompoundMerge>, I>>(base?: I): DecomposeReq2_CompoundMerge {
    return DecomposeReq2_CompoundMerge.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_CompoundMerge>, I>>(object: I): DecomposeReq2_CompoundMerge {
    const message = createBaseDecomposeReq2_CompoundMerge();
    message.d1 = (object.d1 !== undefined && object.d1 !== null)
      ? DecomposeReq2_Decomp.fromPartial(object.d1)
      : undefined;
...
function createBaseDecomposeReq2_LocalVarBinding(): DecomposeReq2_LocalVarBinding {
  return { name: "", d: undefined };
}

export const DecomposeReq2_LocalVarBinding: MessageFns<DecomposeReq2_LocalVarBinding> = {
  encode(message: DecomposeReq2_LocalVarBinding, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.d !== undefined) {
      DecomposeReq2_Decomp.encode(message.d, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_LocalVarBinding {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_LocalVarBinding();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DecomposeReq2_LocalVarBinding {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      d: isSet(object.d) ? DecomposeReq2_Decomp.fromJSON(object.d) : undefined,
    };
  },

  toJSON(message: DecomposeReq2_LocalVarBinding): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<DecomposeReq2_LocalVarBinding>, I>>(base?: I): DecomposeReq2_LocalVarBinding {
    return DecomposeReq2_LocalVarBinding.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_LocalVarBinding>, I>>(
    object: I,
  ): DecomposeReq2_LocalVarBinding {
    const message = createBaseDecomposeReq2_LocalVarBinding();
    message.name = object.name ?? "";
    message.d = (object.d !== undefined && object.d !== null) ? DecomposeReq2_Decomp.fromPartial(object.d) : undefined;
    return message;
...
function createBaseDecomposeReq2_LocalVarParallelSet(): DecomposeReq2_LocalVarParallelSet {
  return { bindings: [], andThen: undefined };
}

export const DecomposeReq2_LocalVarParallelSet: MessageFns<DecomposeReq2_LocalVarParallelSet> = {
  encode(message: DecomposeReq2_LocalVarParallelSet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.bindings) {
      DecomposeReq2_LocalVarBinding.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.andThen !== undefined) {
      DecomposeReq2_Decomp.encode(message.andThen, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_LocalVarParallelSet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_LocalVarParallelSet();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.bindings.push(DecomposeReq2_LocalVarBinding.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.andThen = DecomposeReq2_Decomp.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DecomposeReq2_LocalVarParallelSet {
    return {
      bindings: globalThis.Array.isArray(object?.bindings)
        ? object.bindings.map((e: any) => DecomposeReq2_LocalVarBinding.fromJSON(e))
        : [],
      andThen: isSet(object.andThen) ? DecomposeReq2_Decomp.fromJSON(object.andThen) : undefined,
    };
  },

  toJSON(message: DecomposeReq2_LocalVarParallelSet): unknown {
    const obj: any = {};
    if (message.bindings?.length) {
      obj.bindings = message.bindings.map((e) => DecomposeReq2_LocalVarBinding.toJSON(e));
    }
    if (message.andThen !== undefined) {
      obj.andThen = DecomposeReq2_Decomp.toJSON(message.andThen);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<DecomposeReq2_LocalVarParallelSet>, I>>(
    base?: I,
  ): DecomposeReq2_LocalVarParallelSet {
    return DecomposeReq2_LocalVarParallelSet.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_LocalVarParallelSet>, I>>(
    object: I,
  ): DecomposeReq2_LocalVarParallelSet {
    const message = createBaseDecomposeReq2_LocalVarParallelSet();
    message.bindings = object.bindings?.map((e) => DecomposeReq2_LocalVarBinding.fromPartial(e)) || [];
    message.andThen = (object.andThen !== undefined && object.andThen !== null)
      ? DecomposeReq2_Decomp.fromPartial(object.andThen)
      : undefined;
    return message;
  },
};

function createBaseDecomposeReq2_LocalVarGet(): DecomposeReq2_LocalVarGet {
  return { name: "" };
}

export const DecomposeReq2_LocalVarGet: MessageFns<DecomposeReq2_LocalVarGet> = {
  encode(message: DecomposeReq2_LocalVarGet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_LocalVarGet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_LocalVarGet();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): DecomposeReq2_LocalVarGet {
    return { name: isSet(object.name) ? globalThis.String(object.name) : "" };
  },

  toJSON(message: DecomposeReq2_LocalVarGet): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<DecomposeReq2_LocalVarGet>, I>>(base?: I): DecomposeReq2_LocalVarGet {
    return DecomposeReq2_LocalVarGet.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_LocalVarGet>, I>>(object: I): DecomposeReq2_LocalVarGet {
    const message = createBaseDecomposeReq2_LocalVarGet();
    message.name = object.name ?? "";
    return message;
  },
...
function createBaseDecomposeReq2_Decomp(): DecomposeReq2_Decomp {
  return {
...
export const DecomposeReq2_Decomp: MessageFns<DecomposeReq2_Decomp> = {
  encode(message: DecomposeReq2_Decomp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fromArtifact !== undefined) {
      Art.encode(message.fromArtifact, writer.uint32(10).fork()).join();
    }
    if (message.byName !== undefined) {
      DecomposeReq2_ByName.encode(message.byName, writer.uint32(18).fork()).join();
    }
    if (message.merge !== undefined) {
      DecomposeReq2_Merge.encode(message.merge, writer.uint32(26).fork()).join();
    }
    if (message.compoundMerge !== undefined) {
      DecomposeReq2_CompoundMerge.encode(message.compoundMerge, writer.uint32(34).fork()).join();
    }
    if (message.prune !== undefined) {
      DecomposeReq2_Prune.encode(message.prune, writer.uint32(42).fork()).join();
    }
    if (message.combine !== undefined) {
      DecomposeReq2_Combine.encode(message.combine, writer.uint32(50).fork()).join();
    }
    if (message.get !== undefined) {
      DecomposeReq2_LocalVarGet.encode(message.get, writer.uint32(82).fork()).join();
    }
    if (message.set !== undefined) {
      DecomposeReq2_LocalVarParallelSet.encode(message.set, writer.uint32(90).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DecomposeReq2_Decomp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDecomposeReq2_Decomp();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.byName = DecomposeReq2_ByName.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.merge = DecomposeReq2_Merge.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.compoundMerge = DecomposeReq2_CompoundMerge.decode(reader, reader.uint32());
          continue;
        }
        case 5: {
          if (tag !== 42) {
          ...
          message.prune = DecomposeReq2_Prune.decode(reader, reader.uint32());
          continue;
        }
        case 6: {
          if (tag !== 50) {
          ...
          message.combine = DecomposeReq2_Combine.decode(reader, reader.uint32());
          continue;
        }
        case 10: {
          if (tag !== 82) {
          ...
          message.get = DecomposeReq2_LocalVarGet.decode(reader, reader.uint32());
          continue;
        }
        case 11: {
          if (tag !== 90) {
          ...
          message.set = DecomposeReq2_LocalVarParallelSet.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DecomposeReq2_Decomp {
    return {
      fromArtifact: isSet(object.fromArtifact) ? Art.fromJSON(object.fromArtifact) : undefined,
      byName: isSet(object.byName) ? DecomposeReq2_ByName.fromJSON(object.byName) : undefined,
      merge: isSet(object.merge) ? DecomposeReq2_Merge.fromJSON(object.merge) : undefined,
      compoundMerge: isSet(object.compoundMerge)
        ? DecomposeReq2_CompoundMerge.fromJSON(object.compoundMerge)
        : undefined,
      prune: isSet(object.prune) ? DecomposeReq2_Prune.fromJSON(object.prune) : undefined,
      combine: isSet(object.combine) ? DecomposeReq2_Combine.fromJSON(object.combine) : undefined,
      get: isSet(object.get) ? DecomposeReq2_LocalVarGet.fromJSON(object.get) : undefined,
      set: isSet(object.set) ? DecomposeReq2_LocalVarParallelSet.fromJSON(object.set) : undefined,
    };
  },

  toJSON(message: DecomposeReq2_Decomp): unknown {
    const obj: any = {};
    if (message.fromArtifact !== undefined) {
      obj.fromArtifact = Art.toJSON(message.fromArtifact);
    }
    if (message.byName !== undefined) {
      obj.byName = DecomposeReq2_ByName.toJSON(message.byName);
    }
    if (message.merge !== undefined) {
      obj.merge = DecomposeReq2_Merge.toJSON(message.merge);
    }
    if (message.compoundMerge !== undefined) {
      obj.compoundMerge = DecomposeReq2_CompoundMerge.toJSON(message.compoundMerge);
    }
    if (message.prune !== undefined) {
      obj.prune = DecomposeReq2_Prune.toJSON(message.prune);
    }
    if (message.combine !== undefined) {
      obj.combine = DecomposeReq2_Combine.toJSON(message.combine);
    }
    if (message.get !== undefined) {
      obj.get = DecomposeReq2_LocalVarGet.toJSON(message.get);
    }
    if (message.set !== undefined) {
      obj.set = DecomposeReq2_LocalVarParallelSet.toJSON(message.set);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<DecomposeReq2_Decomp>, I>>(base?: I): DecomposeReq2_Decomp {
    return DecomposeReq2_Decomp.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecomposeReq2_Decomp>, I>>(object: I): DecomposeReq2_Decomp {
    const message = createBaseDecomposeReq2_Decomp();
    ...
    message.byName = (object.byName !== undefined && object.byName !== null)
      ? DecomposeReq2_ByName.fromPartial(object.byName)
      : undefined;
    message.merge = (object.merge !== undefined && object.merge !== null)
      ? DecomposeReq2_Merge.fromPartial(object.merge)
      : undefined;
    message.compoundMerge = (object.compoundMerge !== undefined && object.compoundMerge !== null)
      ? DecomposeReq2_CompoundMerge.fromPartial(object.compoundMerge)
      : undefined;
    message.prune = (object.prune !== undefined && object.prune !== null)
      ? DecomposeReq2_Prune.fromPartial(object.prune)
      : undefined;
    message.combine = (object.combine !== undefined && object.combine !== null)
      ? DecomposeReq2_Combine.fromPartial(object.combine)
      : undefined;
    message.get = (object.get !== undefined && object.get !== null)
      ? DecomposeReq2_LocalVarGet.fromPartial(object.get)
      : undefined;
    message.set = (object.set !== undefined && object.set !== null)
      ? DecomposeReq2_LocalVarParallelSet.fromPartial(object.set)
      : undefined;
    return message;
  },
};
...
export interface Simple {
  ...
  decompose2(request: DecomposeReq2): Promise<DecomposeRes>;
...
export class SimpleClientImpl implements Simple {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.decompose2 = this.decompose2.bind(this);
  ...
  decompose2(request: DecomposeReq2): Promise<DecomposeRes> {
    const data = DecomposeReq2.encode(request).finish();
    const promise = this.rpc.request(this.service, "decompose2", data);
    return promise.then((data) => DecomposeRes.decode(new BinaryReader(data)));
  }
