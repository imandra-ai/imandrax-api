...
class _ClientBase:
    """Shared base with common utilities. Does not define API methods."""
    ...
    class AsyncClient(_ClientBase):
        ...
        async def test_src(
            ...
            return await self._client.test_src(
                ctx=self.mk_context(),
                request=simple_api_pb2.TestSrcReq(
        ...
        async def qcheck_src(
            ...
            return await self.test_src(src, seed, timeout)
        ...
        async def qcheck_name(
            ...
            return await self.test_name(name, seed, timeout)
