...
and t_inner =
  (Imandrax_api_mir.Term.t, Imandrax_api_mir.Type.t, t) Proof_term_poly.t
[@@deriving twine, typereg]

let rec pp out self =
  Proof_term_poly.pp Imandrax_api_mir.Term.pp Imandrax_api_mir.Type.pp pp out
    self.p

let show = Fmt.to_string pp

type view = (Imandrax_api_mir.Term.t, Imandrax_api_mir.Type.t, t) View.t
[@@deriving show]

type arg = (Imandrax_api_mir.Term.t, Imandrax_api_mir.Type.t) Arg.t
[@@deriving show]
